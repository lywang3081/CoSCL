...
def get_args():
    ...
    parser.add_argument('--lamb1', type=float, default=0, help='Lambda')
    parser.add_argument('--lamb2', type=float, default=0, help='Lambda')
    parser.add_argument('--lamb3', type=float, default=0, help='Lambda')
    parser.add_argument('--lamb_emp', type=float, default=0, help='Lambda for fg')
    parser.add_argument('--lamb_emp_fo', type=float, default=0, help='Lambda for first order fg')
    parser.add_argument('--s_gate', type=float, default=0, help='Lambda')

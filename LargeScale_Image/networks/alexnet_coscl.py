...
class AlexNet(nn.Module):
    ...
    def __init__(self, taskcla):
        ...
        #self.efc1 = torch.nn.Embedding(len(self.taskcla), self.f_size * 64)
        ...
        #self.efc2 = torch.nn.Embedding(len(self.taskcla), self.f_size * 64)
        ...
        #self.efc3 = torch.nn.Embedding(len(self.taskcla), self.f_size * 64)
        ...
        #self.efc4 = torch.nn.Embedding(len(self.taskcla), self.f_size * 64)
        ...
        #self.efc5 = torch.nn.Embedding(len(self.taskcla), self.f_size * 64)
    ...
    def mask(self,t,s=1):
        ...
        #gfc6 = self.sig_gate(s * self.efc6(t))

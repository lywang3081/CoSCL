...
class ImageNet(Dataset):
    def __init__(self):
        ...
        traindir = '/raid/LargeData/Large/ImageNet/train'
        valdir = '/raid/LargeData/Large/ImageNet/val'
...
class tinyImageNet(Dataset):
    def __init__(self):
        super().__init__(200, "tinyImageNet", args.tasknum)

        normalize = transforms.Normalize(mean=[0.485, 0.456, 0.406],
                                         std=[0.229, 0.224, 0.225])

        traindir = "../dat/tiny-imagenet-200/train" #'/raid/LargeData/Large/ImageNet/train'
        valdir = "../dat/tiny-imagenet-200/val" #'/raid/LargeData/Large/ImageNet/val'
        ...
        print('tinyImageNet Load finished!')

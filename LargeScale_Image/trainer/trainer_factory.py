...
class TrainerFactory():
    ...
    def get_trainer(myModel, args, optimizer, evaluator, taskcla, model_emp = None):
        ...
        elif args.trainer == 'ewc_coscl':
            import trainer.ewc_coscl as trainer
        elif args.trainer == 'afec_ewc':
            import trainer.afec_ewc as trainer
        elif args.trainer == 'mas':
            import trainer.mas as trainer
        elif args.trainer == 'mas_coscl':
            import trainer.mas_coscl as trainer
        ...
        elif args.trainer == 'gs_coscl':
            import trainer.gs_coscl as trainer
        elif args.trainer == 'hat':
            import trainer.hat as trainer
